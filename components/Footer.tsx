...
const Footer = () => {
  return (
    <footer className="w-full pt-5 md:pt-16 lg:pt-20 pb-10" id="contact">
      ...
      <div className="flex flex-col gap-5 relative items-center">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full md:gap-8">
            ...
            <textarea
              required
              className="md:col-span-2 w-full h-36 block  px-4 py-4 text-white bg-black-200 border border-white/[0.2] rounded-lg focus:outline-none "
              name="message"
              id="message"
      ...
      <div className="flex mt-16 md:flex-row-reverse gap-10 flex-col justify-between items-center">
